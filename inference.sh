...
# python inference.py --data_folder images_face_crop --file_name R18_FC_AGE.csv --dtype FC
# python inference.py --data_folder images_seg_crop --file_name R18_SC_AGE.csv --dtype SC
python inference.py --data_folder images_seg_crop_face_upper --file_name R18_SCFU_AGE.csv --dtype SCFU
